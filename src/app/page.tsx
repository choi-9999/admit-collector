...
const INIT_UNIVERSITIES: Record<string, { code: string; depts: Record<string, string> }> = {
  ...
  "한국항공대학교": { code: "G", depts: { "AI융합대학": "000", "AI자율주행시스템공학과": "000", "공과대학": "000", "스마트드론공학과": "000", "자유전공학부(공학적성)": "000", "자유전공학부(사회적성)": "000", "자유전공학부(이학,사회적성)": "000", "자유전공학부(이학적성)": "000", "항공경영대학": "000", "항공경영대학(사회적성)": "000", "항공경영대학(이학적성)": "000", "항공운항학과": "000"} },
